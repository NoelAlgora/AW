...
<body>
	...
	<div id="container">
		<div class="filtros"> 
			<form class="form_date_filtro" method="POST" action="<?= $helper->url('alquiler','dateCarFilter');?>">
			...
			<form class="form_filtro" method="POST" action="<?= $helper->url('alquiler','filter');?>">
	...
	<div class="container_cards">
		<div class="cards">
			...
			<div class="card">
				<a href=<?php echo $helper->url('alquiler','fichavehiculo', $value['id'])?> >
				<span class="card-header" style="<?php echo " background-image: url( " . $helper->getAlquilerImageUrl($value['id'], $value['list_img']) ."); "?>">
			...
			<div class="info_list_car">
				...
				<a href=<?php echo $helper->url('alquiler','fichavehiculo', $value['id'])?> ><input class="ctaflat" type="button" value="Reservar"></a>
		</span>
			</div>
			<?php endforeach; ?>
		</div>
