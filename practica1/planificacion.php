...
<div >
	...
	<p> El equipo de desarrollo se basara en un modelo de trabajo Descentralizado Democratico (DD) siguiendo los estandares de ingeniera del software.</p>
	<ul>
		<li>Las tareas de liderazgo recaen sobre aquellos miembros con mas experiencia pero siempre atendiendo a los intereses de todo el equipo. </li>
		<li>Las decisiones, problemas y enfoques se llevan a consenso del grupo.</li>
		<li>La comunicación entre el equipo es cercana y horizontal.</li>
	</ul>
	<h3> Planificación </h3>
	<ul>
		<li>Las tareas se repartirán de forma equitativa entre todos los miembros del grupo.</li>
